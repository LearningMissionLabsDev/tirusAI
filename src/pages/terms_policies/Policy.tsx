...
import rawPolicy from "../content/privacy.json";
...
export default function PrivacyPage() {
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: TOKENS.pageBg, display: "flex", alignItems: "flex-start", py: { xs: 4, md: 8 } }}>
      <Container maxWidth="md">
        <Paper
          ...
          sx={{
            ...
            borderRadius: 3,
            p: { xs: 3, md: 5 },
            boxShadow: "0 10px 30px rgba(0,0,0,0.35), inset 0 0 0 1px rgba(255,255,255,0.03)"
          }}
        >
          <Typography component="h1" variant="h4" align="center" sx={{ color: TOKENS.title, fontWeight: 700, letterSpacing: 0.2, mb: 1 }}>
            {policy.title}
          </Typography>
              ...
              >
                <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 1.5 }}>
                  <Chip
                    label={sec.number}
                    size="small"
                    sx={{ bgcolor: "transparent", border: `1px solid ${TOKENS.accent}`, color: TOKENS.accent, fontWeight: 600, height: 24 }}
                  />
